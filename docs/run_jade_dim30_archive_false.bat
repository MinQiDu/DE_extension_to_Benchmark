...
jade.exe 1500 %dim% %pop_size% %mCR% %mF% %c% %p% 1 %archive% "%algo%"

:: ========== f2 ==========
echo Running f2 with iter = 2000
jade.exe 2000 %dim% %pop_size% %mCR% %mF% %c% %p% 2 %archive% "%algo%"

:: ========== f3 ==========
echo Running f3 with iter = 5000
jade.exe 5000 %dim% %pop_size% %mCR% %mF% %c% %p% 3 %archive% "%algo%"

:: ========== f4 ==========
echo Running f4 with iter = 5000
jade.exe 5000 %dim% %pop_size% %mCR% %mF% %c% %p% 4 %archive% "%algo%"

:: ========== f5 ==========
echo Running f5 with iter = 3000
jade.exe 3000 %dim% %pop_size% %mCR% %mF% %c% %p% 5 %archive% "%algo%"
...
jade.exe 3000 %dim% %pop_size% %mCR% %mF% %c% %p% 7 %archive% "%algo%"
...
jade.exe 1000 %dim% %pop_size% %mCR% %mF% %c% %p% 9 %archive% "%algo%"
echo Running f9 with iter = 5000
jade.exe 5000 %dim% %pop_size% %mCR% %mF% %c% %p% 9 %archive% "%algo%"
